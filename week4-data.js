...
const QUESTIONS = [
  ...
  { id: 10, text: "Quelle est ma chanson préférée en ce moment ?", hisReal: "Love Me Not — Ravyn Lenae", hisGuessAboutHer: "je ne sais pas — on demandera à un chat" },
  ...
  { id: 17, text: "Quel métier je ferais si je changeais tout ?", hisReal: "organisateur d'événements (mariages, etc.)", hisGuessAboutHer: "aucune idée — on demandera à un chat" },
